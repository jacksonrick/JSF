package com.jsf.utils.sdk.fdfs.proto;

import com.jsf.utils.sdk.fdfs.proto.mapper.FdfsParamMapper;
...
public abstract class FdfsResponse<T> {
    ...
    public FdfsResponse() {
        ...
        // this.genericType = ((ParameterizedType) theclass).getActualTypeArguments()[0];
    }
