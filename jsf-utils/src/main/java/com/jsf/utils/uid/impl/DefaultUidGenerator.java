...
import com.jsf.utils.uid.BitsAllocator;
import com.jsf.utils.uid.UidGenerator;
import com.jsf.utils.uid.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    public String parseUID(long uid) {
        ...
        String thatTimeStr = DateUtil.dateToStr(thatTime);
    ...
    public void setEpochStr(String epochStr) {
        if (StringUtils.isNotBlank(epochStr)) {
            ...
            this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds(DateUtil.strToDateDay(epochStr).getTime());
        }
    }
}
