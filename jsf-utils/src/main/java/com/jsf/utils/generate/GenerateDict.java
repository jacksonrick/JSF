...
public class GenerateDict {
    ...
    private static final Logger log = LoggerFactory.getLogger(GenerateDict.class);

    private String tableName = null;
    private String schema = null;
    private Connection conn = null;
    private Integer dbType = 1; // 1-mysql 2-postgresql
    ...
    String html = "<!doctype html><html><head><meta charset=\"UTF-8\"><title>数据字典</title>"
            ...
            + "</head><body><div class=\"container\"><h1 style=\"text-align:center;\">数据字典<small>made by jackson</small></h1>";
    ...
    private void exportFile(String target, String content) throws IOException {
        ...
        bw.flush();
        bw.close();
        log.info("文件输出到：" + file.getAbsolutePath());
    }
