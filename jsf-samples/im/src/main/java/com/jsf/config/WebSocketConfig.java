...
import com.jsf.config.wsm.SocketPrincipal;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        registry.setApplicationDestinationPrefixes("/ws") // 客户端发送地址的前缀，如ws/send
                ...
                .enableSimpleBroker("/receive", "/read") // 客户端订阅地址(后缀),可以设置多个 "/chat1,/chat2"
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (raw != null) {
                    ...
                    if (list != null && list.size() > 0) {
                        ...
                        //List names = raw.get("NAME");
                        StompHeaderAccessor accessor = MessageHeaderAccessor.getAccessor(message, StompHeaderAccessor.class);
                        accessor.setUser(new SocketPrincipal(Long.valueOf(uidStr)));
                    }
                }
