...
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (4, 'alipay', 'gateway', 'https://openapi.alipaydev.com/gateway.do', '支付宝网关-生产环境/沙箱环境', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (5, 'alipay', 'notifyUrl', 'http://xxx/pay/callback/alipay', '支付宝-接收通知的接口', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (6, 'alipay', 'partner', '2088xxx', '支付宝-合作身份者ID，以2088开头由16位纯数字组成的字符串', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (7, 'alipay', 'publicKey', 'pubkey', '支付宝-公钥，使用支付宝提供工具生成后上传至开发者平台', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (8, 'alipay', 'returnUrl', 'http://xxx/pay/page/success', '支付宝-通知页面跳转', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (9, 'alipay', 'rsaPrivateKey', 'prikey', '支付宝-商户私钥,需要PKCS8格式,使用支付宝提供工具生成', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (10, 'alipay', 'seller', 'xxx@sandbox.com', '支付宝-账号', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (11, 'wxpay', 'appid', 'wx47xxx', '微信-在开发平台登记的app应用', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (12, 'wxpay', 'partner', '1482xxx', '微信-商户号、MCH_ID', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (13, 'wxpay', 'partnerKey', 'partner_key', '微信-商户在微信平台设置的32位长度的api秘钥、API_KEY', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (14, 'wxpay', 'notifyUrl', 'http://xxx/pay/callback/wxpay', '微信-异步通知地址', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (15, 'wechat', 'mp_id', 'mp_id', '微信公众号id', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (16, 'wechat', 'mp_key', 'mp_key', '微信公众号key', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (17, 'geetest', 'id', 'geetid', 'geet验证-id', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (18, 'geetest', 'key', 'geetkey', 'geet验证-key', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (19, 'jpush', 'name', 'name', '极光推送', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (20, 'jpush', 'appkey', 'appkey', '极光推送', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (21, 'jpush', 'secret', 'secret', '极光推送', 'string');
INSERT INTO `s_config` (`id`, `grp`, `key`, `val`, `descr`, `type`) VALUES (22, 'jpush', 'ios_product', 'false', 'IOS开发环境-false，生产环境-true', 'boolean');
COMMIT;
