...
import com.jsf.system.Constant;
import com.jsf.utils.http.CookieUtils;
import com.jsf.utils.entity.ResMsg;
import com.jsf.utils.string.StringUtil;
import com.jsf.utils.xml.XmlUtil;
...
public class WxController {
    ...
    public String oauth(String code, String state, HttpServletResponse response) throws IOException {
        ...
        if (ResCode.HTTP_OK.code().equals(res.getCode())) {
            ...
            throw new RuntimeException("请求状态码错误");
        }
