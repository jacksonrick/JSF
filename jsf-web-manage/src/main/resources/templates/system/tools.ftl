...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#js" aria-controls="js" role="tab" data-toggle="tab">工具</a></li>
</ul>
    ...
    <div role="tabpanel" class="tab-pane fade" id="js">
        <div class="wrapper-content">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <a class="btn btn-sm btn-info btn-tools" data-url="/admin/system/icons">本地FontAwesome图标库</a>
