...
import com.jsf.mapper.AddressMapper;
...
public class AddrService {
    ...
    public String genAddr() {
        ...
        a1.setLevel(1);
        List<Address> list1 = this.findAddrList(a1);
        ...
        for (Address addr1 : list1) {
            ...
            List<Address> list2 = this.findAddrList(a2);
        ...
        for (Address addr2 : list2) {
            ...
            List<Address> list3 = this.findAddrList(a3);
        ...
        for (Address addr3 : list3) {
            ...
            List<Address> list4 = this.findAddrList(a4);
