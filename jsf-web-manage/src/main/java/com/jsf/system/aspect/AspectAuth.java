...
import com.jsf.utils.exception.AdminNoLoginException;
import com.jsf.utils.exception.NotAllowException;
...
public class AspectAuth {
    ...
    @Pointcut("@annotation(com.jsf.utils.annotation.AuthPassport)")
    public void auth() {
    }
