...
public class SMService {
    ...
    private static final Log log = LogFactory.getLog(SMService.class);
    ...
    private String getText(Map<String, String> root, String templateName) {
        ...
        try {
            ...
            Template tpl = freeMarkerConfigurer.getConfiguration().getTemplate("tpl/sms/" + templateName + ".ftl");
